 ...
 */
final class Version20240809080808 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ingredients DROP quanity, CHANGE type type VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ingredients ADD quanity DOUBLE PRECISION NOT NULL, CHANGE type type VARCHAR(255) DEFAULT \'NULL\'');
    }
}
